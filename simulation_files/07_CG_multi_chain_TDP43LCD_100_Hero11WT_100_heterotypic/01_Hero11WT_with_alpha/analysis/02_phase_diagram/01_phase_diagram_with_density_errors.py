...
def main():
    ...
    for j in range(num_temperature_meaningful):
        # be careful! j + 2 is correct for T=260, 270, ...
        fname = "../density_evolution/{0}_md4_T_{1:0>2d}_density_averaged.dat".format(pro0_name, j + 2)
        # fname = "../density_evolution/{0}_md4_T_{1:0>2d}_density_averaged.dat".format(pro0_name, j + 1)
