...
def main():
    ...
    for i, t in enumerate(T_list):
        ...
        axes[i * 2].imshow(data0_local.T, cmap="Blues", vmin=0.000001, vmax=.005, origin="lower")
        axes[i * 2 + 1].imshow(data1_local.T, cmap="Reds", vmin=0.000001, vmax=.005, origin="lower")
    ...
    figname = "{0}_{1}_md4_T_density_no_center.png".format(pro0_name, pro1_name)
