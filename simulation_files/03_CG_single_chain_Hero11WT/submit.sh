...
for t in {01..25}; do        # temperature
    for r in {01..05}; do        # temperature
        ...
        cp hero11_alpha.top  hero11_T_${t}_$r.top
        # mycrdfile=$(echo "$t % 5 + 1" | bc)
        cp crd/hero11_alpha.gro crd/hero11_T_${t}_$r.gro
        sed -e "s/TOPFILE/hero11_T_${t}_$r/g" -i md${j}_T_${t}_$r.atin
        sed -e "s/CRDFILE/hero11_T_${t}_$r/g" -i md${j}_T_${t}_$r.atin
        sed -e "s/TEMPLATE/hero11_alpha_md${j}_T_${t}_$r/g" -i md${j}_T_${t}_$r.atin
