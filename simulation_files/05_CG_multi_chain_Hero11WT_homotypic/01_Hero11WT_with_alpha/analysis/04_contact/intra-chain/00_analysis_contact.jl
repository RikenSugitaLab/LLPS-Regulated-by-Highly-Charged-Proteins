...
function calculate_contact_map(i_temperature, i_run)
    ...
    # data structures
    # ---------------
    data_pro1_all = zeros(Int, (NUM_ATOM_PRO1, NUM_ATOM_PRO1))
    ...
    for i_frame in 1:n_structures
        ...
        Threads.@threads for i_cell in 1:num_cell_all
            i_z, i_xy = divrem(i_cell, num_cell_x * num_cell_y)
                        ...
                        for i_atom in cell_particle_list[i_cell]
                            ...
                            for j_atom in cell_particle_list[j_cell]
                                ...
                                if dist < contact_cutoff
                                    ...
                                    data_pro1_all[idx_i, idx_j] += 1
                                    data_pro1_all[idx_j, idx_i] += 1
                                end
                            end # j_atom
                        end     # i_atom
                    end         # dz
    ...
    data_pro1_all_ave = data_pro1_all ./ n_structures

    of_name = @sprintf("%s_contacts_t%02d_r%02d.dat", name_pro1, i_temperature, i_run)
