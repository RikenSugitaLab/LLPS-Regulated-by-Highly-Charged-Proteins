...
def count_dense_contacts(T, n_hero):
    ...
    for i_run in range(n_run):
        # hero11-hero11
        cnt_00 = []
        fname0 = "./md3/tdp43_100_hero11_{2}_T{0}_md3_r{1:0>2d}.hero11-hero11.dense.contact_count_ts.dat"
        ...
        # tdp43-tdp43
        cnt_11 = []
        fname0 = "./md3/tdp43_100_hero11_{2}_T{0}_md3_r{1:0>2d}.tdp43-tdp43.dense.contact_count_ts.dat"
        fname = fname0.format(T, i_run + 1, n_hero)
        with open(fname, "r") as fin:
            for line in fin:
                tmp_sum = 0
    ...
    fout_name = "MOL_NUM_T{0}_nHero_{1}_dense_all.dat".format(T, n_hero)
