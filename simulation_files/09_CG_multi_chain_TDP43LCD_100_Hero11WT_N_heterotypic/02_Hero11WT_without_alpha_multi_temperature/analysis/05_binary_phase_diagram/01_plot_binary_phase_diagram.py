...
def main():
    ...
    for i_T in range(n_T):
        ...
        for i_C in range(n_C):
            # if i_C % 2 == 1:
            if i_C not in [ 2, 4, 6, 8]:
                continue
            print("analyzing #T: ", i_T + 1, "  #Hero: ", i_C + 1)
            data_1_fname = "../01_density_in_box/tdp43_100_hero11_{0}_T_{1}_tdp43_density_averaged.dat".format(fC(i_C), fT(i_T))
            data_2_fname = "../01_density_in_box/tdp43_100_hero11_{0}_T_{1}_hero11_density_averaged.dat".format(fC(i_C), fT(i_T))
        ...
        for i_C in [10]:
            ...
            data_1_fname = "/home/ctan/Port/WDElement16T/MEGAMINX_BAK/MEGAMINX_HD1/HERO/TDP43+Hero11/20220208_first_test_with_Hero11_no_helix/34_tdp43_100_hero11_wt_100_multi_T_250_350_hokusai_md4/analysis/density_evolution/tdp43_md4_T_{0:>02d}_density_averaged.dat".format(i_T + 2)
            data_2_fname = "/home/ctan/Port/WDElement16T/MEGAMINX_BAK/MEGAMINX_HD1/HERO/TDP43+Hero11/20220208_first_test_with_Hero11_no_helix/34_tdp43_100_hero11_wt_100_multi_T_250_350_hokusai_md4/analysis/density_evolution/hero11_md4_T_{0:>02d}_density_averaged.dat".format(i_T + 2)
