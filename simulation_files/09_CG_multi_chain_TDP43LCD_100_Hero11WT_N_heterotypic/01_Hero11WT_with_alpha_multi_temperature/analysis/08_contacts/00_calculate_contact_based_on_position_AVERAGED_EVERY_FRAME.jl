...
@everywhere function calculate_contact_map(temperature, n_hero, i_run)
# function calculate_contact_map(temperature, n_hero, i_run)
    ...
    top_name = @sprintf("../../md%d_N_%d_T_%d.top", i_run, n_hero, temperature)
    ...
    # --------------------------
    pro1_phase_data_fname = @sprintf("../03_molecular_position/md%d/%s_t%3d_md%d.%s_pos.dat", i_run, system_name, temperature, i_run, name_pro1)
    pro2_phase_data_fname = @sprintf("../03_molecular_position/md%d/%s_t%3d_md%d.%s_pos.dat", i_run, system_name, temperature, i_run, name_pro2)
    ...
    # output...
    # =========
    pro1_pro1_dense_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_matrix.dat", system_name, temperature, i_run, name_pro1, name_pro1, "dense")
    pro2_pro2_dense_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_matrix.dat", system_name, temperature, i_run, name_pro2, name_pro2, "dense")
    pro1_pro2_dense_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_matrix.dat", system_name, temperature, i_run, name_pro1, name_pro2, "dense")
    pro2_pro1_dense_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_matrix.dat", system_name, temperature, i_run, name_pro2, name_pro1, "dense")
    pro1_pro1_dilute_of_name = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_matrix.dat", system_name, temperature, i_run, name_pro1, name_pro1, "dilute")
    pro2_pro2_dilute_of_name = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_matrix.dat", system_name, temperature, i_run, name_pro2, name_pro2, "dilute")
    pro1_pro2_dilute_of_name = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_matrix.dat", system_name, temperature, i_run, name_pro1, name_pro2, "dilute")
    pro2_pro1_dilute_of_name = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_matrix.dat", system_name, temperature, i_run, name_pro2, name_pro1, "dilute")
    ...
    cc_p1_11_dense_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_count_ts.dat", system_name, temperature, i_run, name_pro1, name_pro1, "dense")
    cc_p1_12_dense_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_count_ts.dat", system_name, temperature, i_run, name_pro1, name_pro2, "dense")
    cc_p2_21_dense_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_count_ts.dat", system_name, temperature, i_run, name_pro2, name_pro1, "dense")
    cc_p2_22_dense_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_count_ts.dat", system_name, temperature, i_run, name_pro2, name_pro2, "dense")
    cc_p1_11_dilute_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_count_ts.dat", system_name, temperature, i_run, name_pro1, name_pro1, "dilute")
    cc_p1_12_dilute_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_count_ts.dat", system_name, temperature, i_run, name_pro1, name_pro2, "dilute")
    cc_p2_21_dilute_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_count_ts.dat", system_name, temperature, i_run, name_pro2, name_pro1, "dilute")
    cc_p2_22_dilute_of_name  = @sprintf("%s_t%03d_md%d.%s-%s.%s.contact_count_ts.dat", system_name, temperature, i_run, name_pro2, name_pro2, "dilute")
